                      ...
                      {(entry.images||[]).map((src: string, idx: number) => {
                        ...
                        return (
                          <div key={idx} style={{ position:"relative" }}>
                            ...
                            <button onClick={e => { e.stopPropagation(); onImgDelete(idx); }} style={{ position:"absolute", top:-6, right:-6, width:19, height:19, borderRadius:"50%", background:"#ef4444", border:"none", color:"#fff", fontSize:11, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", l